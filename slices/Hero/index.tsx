...
const Hero: FC<HeroProps> = ({ slice }) => {
  return (
    ...
    >
      <div className='hero-scene pointer-events-none sticky top-0 h-dvh w-full'></div>

      <div className='hero-content absolute inset-x-0 top-0 h-dvh w-full'>
        <Bounded
          fullWidth
          className='absolute top-18 inset-x-0 md:top-24 md:left-[8vw]'
        >
          <PrismicRichText
