...
const Marquee: FC<MarqueeProps> = ({ slice }) => {
  const MarqueeContent = () => (
    <div className='flex items-center bg-gray-200 py-10 whitespace-nowrap'>
      {slice.primary.phrases.map((itme, i) => (
        <Fragment key={i}>
          <div className='font-bold-slanted px-14 text-[180px] leading-none text-gray-400/80 md:text-[260px] uppercase [text-box:trim-both_cap_alphabetic]'>
            {itme.text}
          </div>
