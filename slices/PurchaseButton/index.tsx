    ...
    >
      <FadeIn className='relative mx-auto max-w-7xl px-4 text-center'>
        ...
        <PrismicRichText
          ...
          components={{
            heading2: ({ children }) => (
              <h1 className='font-bold-slanted mb-8 scroll-pt-6 text-5xl text-gray-900 uppercase md:text-7xl lg:text-8xl'>
                {children}
              </h1>
            ),
          }}
        ...
        <div className='mt-12 space-y-3 text-base text-gray-600 md:text-lg'></div>
